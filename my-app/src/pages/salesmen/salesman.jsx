            ...
            <Container className= 'p-5' >
                <Row>
                    <Col className="p-1 border-bottom d-md-flex " sm={12}>
                        <h3 className='col-md-8'> Salesman</h3>
                        <Button classsName="col-md-2 " variant="primary" onClick={handleShow_new}> New Salesman</Button>
    ...
    {/* new salesman Modal */}
      <Modal id="newcustomer" show={show_new} onHide={handleClose_new}>
        <Modal.Header closeButton>
          <Modal.Title>New Salesman</Modal.Title>
        </Modal.Header>
        <Form>
        ...
        <Modal.Body>
            <Form.Group className="mb-3" controlId="formBasicEmail">
                ...
                <Form.Control type="text" placeholder="ammarkaid321@gmail.com" />
